...
-- EXEC [dbo].[Transactions_GetInProcessRequestList] @JsonData='{"PageNum":1, "PageSize":10, "SearchText": "", "StatusId": 1}', @LogInUserId=1
-- =============================================
CREATE PROCEDURE [dbo].[Transactions_GetInProcessRequestList]
...
BEGIN
	...
	------------------------------------------------------------------------------------------------------------------------------------
		...
		Select 
				...
				TransactionStatus,
				Remarks,
				ISNULL(AssignParty, 0) AS AssignParty
