...
-- EXEC [dbo].[Transactions_GetTransactionList] @JsonData='{"PageNum":1, "PageSize":10, "SearchText": "", "UserId" : 129}', @LogInUserId=1
-- =============================================
CREATE PROCEDURE [dbo].[Transactions_GetTransactionList_Backup]
